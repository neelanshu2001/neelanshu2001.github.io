...
const Header = ({ name='Neelanshu Garg', role='Actively Looking', contacts='neelanshgarg0@gmail.com' }) => (
  <header className="border-b border-neutral-300 pb-2 md:flex items-center justify-between">
    <div>
      ...
      <h2 className="font-light text-lg md:text-2xl text-slate-800 leading-relaxed tracking-widest">
        {role}
      </h2>
    </div>
